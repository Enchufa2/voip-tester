...
public class GestorDatosMensaje {
     ...
     *
     * @param numeroDeMensajes  El número de mensajes sobre que los que se extraen los datos.
     ...
     * por la posición <code>offset</code>, a partir del mensaje <code>primerMensaje</code>.
     * rellenando el campo de datos de este.
     * El número de bytes <code>longitud</code> debe ser menor que
     *              <code> (mensajes.length - primerMensaje)*longitudDatosMensaje </code>
     *
     * @param datos          Las datos a mapear en los mensajes
     * @param offset         La posición dentro de <code>datos</code> a partir de la cual se empiezan a copiar los datos
     * @param longitud       El número total de bytes a copiar
     ...
     * @param numeroDeMensajes      Número de mensajes que se utilizarán para albergar los datos
     ...
     * obtenidos a partir de los datos de los mensajes. El número de ficheros viene dado por:
     ...
     * <code>x</code> es el orden de creación de los ficheros, y tendrán extensión <code>.wav</code>.
     *
     *
     * @param  directorioFicheros           El path donde se alojarán los ficheros obtenidos
