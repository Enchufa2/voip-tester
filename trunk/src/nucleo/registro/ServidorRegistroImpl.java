...
public class ServidorRegistroImpl implements ServidorRegistro {
    ...
    /**
     * Contiene la asociación del cliente registrado y el nodo asociado, al cuál
    ...
    /**
     * Servicio de comprobación de actividad/disponibilidad del cliente.
     */
    private ComprobadorActividad comprobadorActividad;

    /**
     * Intervalo de tiempo que dispone el cliente para notificar al servidor
     * de su actividad antes de que el servidor de registro lo compruebe por sí mismo.
     */
     ...
     *                              Si el servidor de registro no está activo
     *
    ...
    /**
     * Desconecta al cliente del servidor de registro, dejándolo libre para otros clientes.
     * El nodo asociado también se destruye.
     *
     * @param clienteNodo   El cliente que pide ser desconectado
     *
     * @throws RegistroException    Si el cliente que inicia la petición es distinto al registrado
     *                              Si el servidor de registro no está activo
     *
     * @see ClienteNodo
     * @see #eliminarCliente()
     ...
     */
     ...
     /**
      * Destruye el nodo asociado el cliente y deja libre la asociación cliente - nodo
      * 
      */
     public void eliminarCliente()  {
         ...
         try{
            ...
            this.registroLogger.finer("Remote socket closed");
             ...
             //el nodo se encontraba en proceso de generación de timestamps
     ...
     /**
      * Comprueba si existe un cliente en la asociación de cliente registrado
      *
      * @return   <code>true</code>     Si aparece un cliente en la asociación de cliente registrado
      */
      ...
      *
      * @param tiempoExpiracion_ms      El tiempo de expiración en milisegundos
      */
     ...
     *
     * @throws RegistroException    Si las direcciones de red forman una URL no válida
    ...
    /**
     * Comprueba si el servidor está activo/exportado en el registro RMI
     *
     * @throws RegistroException    Si las direcciones de red forman una URL no válida
     * @throws RemoteException      Si ocurre un error en la operación remota
     *
