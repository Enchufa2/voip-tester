...
public class ControlNodos {
    ...
    /**
     * Timestamps de emisor generados por petici贸n en el protocolo de tiemstamps
     *
    ...
    /**
     * Timestamps de recepci贸n generados por petici贸n en el protocolo de tiemstamps
     * @see ProtocoloTimestamps
     * @see #obtenerTimestampsEnlaceAscendente(int)
     * @see #obtenerTimestampsEnlaceDescendente(int)
     */
    ...
    /**
     * Timestamps de sincronizaci贸n generados por petici贸n en el protocolo de sincronizacion
     *
     ...
     * 
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (loca)
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo servidor (servidor)
     *
     *
     */
     ...
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (local)
     */
     ...
     * est谩n conectados
     *
     * @return <code>true</code>    Si los sockets est谩n conectados
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (local)
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo servidor (servidor)
     */
    ...
    /**
     * Ajusta la direcci贸n del socket local del protocolo de timestamps,
     * especificando el host y puerto local a los que se unir谩 el socket.
     *
    ...
    /**
     * Permite configurar de manera remota la direcci贸n remota del socket
     * del protocolo de timestamp del nodo remoto
     *
     * @param hostRemoto         Nombre de host o direcci贸n del host remoto a la que se une el socket
     * @param puertoRemoto       Puerto remoto al que se une el socket
     *
     * @throws NodoServidorException     Si ocurre un error con en la operaci贸n efectuada en el nodo servidor (remoto)
     *
     */
    ...
    /**
     * Realiza el procedimiento de sincronizaci贸n con el nodo remoto, obteni茅ndo los timestamps
     * de sincronizaci贸n.
     * La petici贸n de espera de sincronizaci贸n del remoto se realiza en una hebra para evitar el
     * bloqueo que produce dicha petici贸n.
     *
     *
     * @throws InterruptedException     Si la hebra que atiende la petici贸n se ve interrumpida
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (local)
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo servidor (servidor)
     *
    ...
    /**
     * Estima los par谩metros de sincronizaci贸n offset local y tiempo de ida y vuelta,
    ...
    /**
     *  Fija los par谩metros de transmisi贸n en el nodo local y remoto
     *
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (local)
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo servidor (servidor)
     *
     ...
     * creando los buffers de mensajes de emisi贸n en el nodo local y de recepci贸n en
     * el nodo remoto.
     *
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (local)
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo servidor (servidor)
    ...
    /**
     * Configura los objetos que proporcionan el servicio del protocolo de timestamps,
     * creando los buffers de mensajes de emisi贸n en el nodo remoto y de recepci贸n en
     * el nodo local.
     *
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo cliente (local)
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo servidor (servidor)
     ...
     * de acuerdo a los par谩metros de transmisi贸n especificados.
     * Este m茅todo se llama cuando se desea enviar audio en mensajes desde el nodo local al
     * remoto.
     * 
     *
     * @throws NodoClienteException     Si ocurre un error con en la operaci贸n efectuada en el nodo local (cliente)
     *
     */
     ...
     * de acuerdo a los par谩metros de transmisi贸n especificados.
     * Este m茅todo se llama cuando se desea enviar audio en mensajes desde el nodo remoto al
     * local.     
     *
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo remoto (servidor)
     *
     */
     ...
     * codificado.
     * Este m茅todo se llama cuando el nodo local recibe mensajes de audio enviado por el nodo remoto
     *
     * @return                         Los bytes de audio recibido. Cada fila representa los bytes para un intervalo
     * @throws NodoClienteException    Si ocurre un error en la la operaci贸n efectuada en el nodo local (cliente)
     *
     */
     ...
     * codificado. 
     * Este m茅todo se llama cuando el nodo remoto recibe mensajes de audio enviado por el nodo local
     *
     * @return                         Los bytes de audio recibido. Cada fila representa los bytes para un intervalo
     * @throws NodoServidorException    Si ocurre un error en la la operaci贸n efectuada en el nodo remoto (Servidor)
     *
     ...
     * para que el nodo local act煤e en modo emisor y el nodo remoto en modo receptor.
     * La petici贸n de modo receptor se realiza en una hebra para evitar el bloqueo.
     *
    ...
    /**
     * Realiza las operaciones necesarias en el protocolo de timestamps
     * para que el nodo local act煤e en modo receptor y el nodo remoto en modo emisor.
     * La petici贸n de modo receptor se realiza en una hebra para evitar el bloqueo.
     *
     * @param rtt_us        Tiempo de ida y vuelta en microsegundos.
     *                      Necesario en el protocolo de timestmaps
    ...
    public abstract class NodoClienteHandler {
        ...
        /**
         * Debe de implementarse con la operaci贸n del nodo local
         *
         * @param argsOperacion     Argumentos que requiere la operaci贸n del nodo local
 ...
 /**
    ...
    public abstract class NodoServidorHandler {
        ...
        /**
         * Debe de implementarse con la operaci贸n del nodo remoto
         *
         * @param argsOperacion     Argumentos que requiere la operaci贸n del nodo remoto
         * @return                  El resultado de la operaci贸n
         */
