...
public class GestorCodecsAudio {
    ...
    /**
     * Crea un conjunto de correspondencias de tama帽o <code>numeroTipoCodecs</code>
     *
     * @param codecsDisponibles     Numero total de codecs que est谩n disponibles y que son 
    ...
    /**
     * A帽ade un fichero multimedia cuyo contenido est茅 comprimido con el codec
    ...
    /**
     * Crea un conjunto de codecs que pueden considerarse para la codificaci贸n
     * Se crea el objeto FormatoCodec correspondiente a帽adiendole las propiedades
     * que tiene el codificador correspondiente.
     *
     * La creaci贸n de los codecs se realiza seg煤n la informaci贸n que proporciona
