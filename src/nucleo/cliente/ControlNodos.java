...
public class ControlNodos {
     ...
     *
     * @param isaLocal                  IP cliente (que puede ser pública) a la que el socket servidor se conectará
     * @param isaRemota                 IP servidor (que puede ser pública) a la que el socket cliente se conectará
     * 
     ...
     *
     */
    public void conectarSockets( final InetSocketAddress isaLocal,
                                final InetSocketAddress isaRemota )
